...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>resources/js/list.js"></script>
	</head>
		...
		<form action="<%=basePath %>List.action" id="mainForm" method="post">
			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<a class="btn03" href="javascript:deleteBatch();">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
					...
					<div class="zixun fix">
							...
							<tbody>
								...
								<c:forEach items="${messageList }" var="message" varStatus="status">
									...
									>
										...
										<td>
											<a href="#">修改</a>&nbsp;&nbsp;&nbsp;
											<a href="javascript:deleteOne(${message.id});">删除</a>
										</td>
									</tr>
								</c:forEach>
						...
						<div class='page fix'>
							...
							跳至&nbsp;<input id="goinput" type='text' value='${page.currentPage }' class='allInput w28' />&nbsp;页&nbsp;
							<a href='javascript:changeCurrentPage($("#goinput").val())' class='go'>GO</a>
						</div>
					</div>
				</div>
			</div>
